...
link = "https://pmis.lsmuni.lt/pm/tvarkarasciai/show.php?a=showcycle&cycle=2321&subcycle=&trg=&groups=22"    # first
#link = 'https://pmis.lsmuni.lt/pm/tvarkarasciai/show.php?a=showcycle&cycle=2385&subcycle=&trg=&groups=22' # second
...
for td in tds[:-1]: # ignore the last item as it's invalid
	...
	if td["class"][0] == 'date':
		...
		month = int(date[0:2])
		year = 2018 if month > 8 else 2019
		day = int(date[-2:])
